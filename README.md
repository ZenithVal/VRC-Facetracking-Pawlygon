...
* Latest [VRCFury](https://vrcfury.com/download) or [Modular Avatar](https://modular-avatar.nadena.dev/)
...
## How to use it
1. Make Sure VRCFury or Modular Avatar is up-to-date and present on your Project.
...
_"VF" is VRCFury and "MA" is Modular Avatar_
